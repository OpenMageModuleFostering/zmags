...
class Tnma_Zmags_Block_Adminhtml_Customtemplates_Edit_Renderer_Label
...
implements Varien_Data_Form_Element_Renderer_Interface
{
    ...
    public function render(Varien_Data_Form_Element_Abstract $element)
    {
        ...
        $html .= ' <label for="' . $htmlId . '" class="normal">' . Mage::helper('tnma_zmags')->__('Do not change value') . '</label>';
